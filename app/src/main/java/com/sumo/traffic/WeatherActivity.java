...
import com.sumo.traffic.Helpers.DayFormatter;
import com.sumo.traffic.Helpers.TemperatureFormatter;
import com.sumo.traffic.Models.CurrentWeather;
import com.sumo.traffic.Models.WeatherForecast;
import com.sumo.traffic.Services.LocationService;
import com.sumo.traffic.Services.WeatherService;
            ...
            mCompositeSubscription.add(fetchDataObservable
                    ...
                    .subscribe(new Subscriber<HashMap<String, WeatherForecast>>() {
                        ...
                        public void onNext(final HashMap<String, WeatherForecast> weatherData) {
                            ...
                            mLocationNameTextView.setText("Quezon City");
