 ...
 */
public class InfoOfPeople extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_people);
 ...
 /*       if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfPeople.this,InfoOfEdsa.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfPeople.this,InfoOfEast.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfPeople.this,InfoOfArt.class);
        startActivity(i);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJkVJ4z-G3lzMRtIL8hox324E" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
