 ...
 */
public class InfoOfWatershed extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_watershed);
...
/*        if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfWatershed.this,InfoOfDam.class);
        startActivity(i);
    ...
    {
        Intent i = new Intent(InfoOfWatershed.this,InfoOfNinoy.class);
        startActivity(i);
    ...
    {
        Intent i = new Intent(InfoOfWatershed.this,InfoOfParish.class);
        startActivity(i);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJS8sCX8e6lzMRuwnG170scsI" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
