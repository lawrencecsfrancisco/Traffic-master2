 ...
 */
public class InfoOfCOF extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_cof);
...
/*        if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfCOF.this,InfoOfMaginhawa.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfCOF.this,InfoOfVargas.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfCOF.this,InfoOfUp.class);
        startActivity(i);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJKeIIzxG3lzMREPRXb7ccU40" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
