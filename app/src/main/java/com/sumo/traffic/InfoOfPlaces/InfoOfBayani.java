...
public class InfoOfBayani extends AppCompatActivity implements View.OnClickListener{
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJ2yEQTQe3lzMRbfDgt60K770" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                layoutManager = new LinearLayoutManager(InfoOfBayani.this);
