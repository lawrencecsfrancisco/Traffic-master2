 ...
 */
public class InfoOfEast extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_eastwood);
...
/*        if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfEast.this,InfoOfPeople.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfEast.this,InfoOfEdsa.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfEast.this,InfoOfArt.class);
        startActivity(i);
        finish();
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJkZH0lR24lzMRii5e_ZiY_Z8" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
