 ...
 */
public class InfoOfDam extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_dam);
 ...
 /*       if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfDam.this,InfoOfVargas.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfDam.this,InfoOfParish.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfDam.this,InfoOfAteneo.class);
        startActivity(i);
