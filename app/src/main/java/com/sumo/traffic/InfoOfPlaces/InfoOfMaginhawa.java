 ...
 */
public class InfoOfMaginhawa extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_maginhawa);
...
/*        if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfMaginhawa.this,InfoOfAteneo.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfMaginhawa.this,InfoOfVargas.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfMaginhawa.this,InfoOfUp.class);
        startActivity(i);
        finish();
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJLyKHcHO3lzMRkPD3eaV8zo4" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
