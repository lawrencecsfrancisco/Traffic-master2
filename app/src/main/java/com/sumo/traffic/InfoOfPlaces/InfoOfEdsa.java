 ...
 */
public class InfoOfEdsa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_edsa);
 ...
 /*       if (ChoicesOfPlace.open == 1) {
    ...
    {
        Intent i = new Intent(InfoOfEdsa.this,InfoOfPeople.class);
        startActivity(i);
        finish();
    }
    ...
    {
        Intent i = new Intent(InfoOfEdsa.this,InfoOfArt.class);
        startActivity(i);
        finish();
    ...
    {
        Intent i = new Intent(InfoOfEdsa.this,InfoOfEast.class);
        startActivity(i);
        finish();
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJ83np5BjIlzMRQnvbQuvP320" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
